...
import { useSSRContext, mergeProps, withCtx, createTextVNode, toDisplayString } from 'file://C:/Users/skalp/Website/oh-my-cv/node_modules/.pnpm/vue@3.4.31_typescript@5.5.3/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent } from 'file://C:/Users/skalp/Website/oh-my-cv/node_modules/.pnpm/vue@3.4.31_typescript@5.5.3/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "font-sans antialiased bg-white dark:bg-black text-black dark:text-white grid min-h-screen place-content-center overflow-hidden" }, _attrs))} data-v-436b1d36><div class="fixed left-0 right-0 spotlight z-10" data-v-436b1d36></div><div class="max-w-520px text-center z-20" data-v-436b1d36><h1 class="text-8xl sm:text-10xl font-medium mb-8" data-v-436b1d36>${ssrInterpolate(__props.statusCode)}</h1><p class="text-xl px-8 sm:px-0 sm:text-4xl font-light mb-16 leading-tight" data-v-436b1d36>${ssrInterpolate(__props.description)}</p><div class="w-full flex items-center justify-center" data-v-436b1d36>`);
...
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-436b1d36"]]);

export { error404 as default };
//# sourceMappingURL=error-404-i9vr6WbY.mjs.map
