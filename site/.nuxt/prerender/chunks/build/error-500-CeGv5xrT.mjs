...
import { useSSRContext, mergeProps } from 'file://C:/Users/skalp/Website/oh-my-cv/node_modules/.pnpm/vue@3.4.31_typescript@5.5.3/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrInterpolate } from 'file://C:/Users/skalp/Website/oh-my-cv/node_modules/.pnpm/vue@3.4.31_typescript@5.5.3/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "font-sans antialiased bg-white dark:bg-black text-black dark:text-white grid min-h-screen place-content-center overflow-hidden" }, _attrs))} data-v-b8cc5a6a><div class="fixed -bottom-1/2 left-0 right-0 h-1/2 spotlight" data-v-b8cc5a6a></div><div class="max-w-520px text-center" data-v-b8cc5a6a><h1 class="text-8xl sm:text-10xl font-medium mb-8" data-v-b8cc5a6a>${ssrInterpolate(__props.statusCode)}</h1><p class="text-xl px-8 sm:px-0 sm:text-4xl font-light mb-16 leading-tight" data-v-b8cc5a6a>${ssrInterpolate(__props.description)}</p></div></div>`);
    };
  }
};
...
const error500 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b8cc5a6a"]]);

export { error500 as default };
//# sourceMappingURL=error-500-CeGv5xrT.mjs.map
