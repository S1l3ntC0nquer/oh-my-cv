import { c as cn, _ as _sfc_main$E, a as _sfc_main$H } from "./Header-CVL2gF3u.js";
import { TabsRoot, TabsList, TabsIndicator, TabsTrigger, Separator, useForwardPropsEmits, TooltipRoot, TooltipPortal, TooltipContent, TooltipTrigger, TooltipProvider, DialogRoot, DialogClose, DialogTrigger, useForwardProps, DialogTitle, DialogDescription, DialogPortal, DialogOverlay, DialogContent, SliderRoot, SliderTrack, SliderRange, SliderThumb, SplitterGroup, SplitterPanel, SplitterResizeHandle } from "radix-vue";
import { defineComponent, ref, mergeProps, unref, withCtx, createTextVNode, createVNode, useSSRContext, computed, h, watch, renderSlot, toDisplayString, toRaw, isRef, openBlock, createBlock, createCommentVNode, withKeys, Fragment, renderList, withDirectives, vShow, resolveDynamicComponent } from "vue";
import { e as useMonaco, f as useStyleStore, g as useDataStore, b as _sfc_main$D, c as useConstant, u as useShortcuts, s as storageService, _ as _sfc_main$F, h as downloadFile, j as fetchFile, d as _sfc_main$G, k as useToast } from "./Skeleton-DmysgnrS.js";
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderSlot, ssrRenderClass, ssrInterpolate, ssrGetDynamicModelProps, ssrRenderList, ssrRenderStyle, ssrRenderVNode } from "vue/server-renderer";
import { f as useElementSize, g as useVModel, h as useI18n, i as useRoute, j as useWindowSize } from "../server.mjs";
import "hookable";
...
const _sfc_main$B = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_SharedResumeRender = _sfc_main$D;
...
const _sfc_main$t = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_SharedUiEditable = _sfc_main$F;
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_EditorToolbarBox = _sfc_main$v;
      const _component_SharedUiCombobox = _sfc_main$b;
      const _component_UiSkeleton = _sfc_main$G;
      _push(ssrRenderComponent(_component_EditorToolbarBox, mergeProps({
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const correct = async () => {
      ...
      setAndSyncToMonaco("markdown", (result == null ? void 0 : result.code) ?? md);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_SharedHeader = _sfc_main$H;
      const _component_UiButton = _sfc_main$E;
...
//# sourceMappingURL=_id_-DBfMMRk-.js.map
